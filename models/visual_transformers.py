...
def initialize_clip(config, num_patches=240):
    ...
    # print (pos_embed.weight, pos_embed.shape)
    # print (clip_model.visual.positional_embedding, clip_model.visual.positional_embedding.shape)
    clip_model.visual.positional_embedding = pos_embed
    # print ("init size: ", clip_model.visual.positional_embedding.shape)
    ...
    return clip_model.visual, preprocess
