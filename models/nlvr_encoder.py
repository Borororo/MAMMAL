...
class BertAttention(nn.Module):
    def __init__(self, config, is_cross_attention=False, layer_num=-1):
        ...
        self.output = BertSelfOutput(config, twin=is_cross_attention, merge=(is_cross_attention and layer_num>=config.nlvr_merge_layer))
...
class BertLayer(nn.Module):
    def __init__(self, config, layer_num):
        ...
        self.has_cross_attention = (layer_num >= config.cross_layer)
